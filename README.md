...
<br>
<p align="center">
  <img src="http://ostdev.minedu.gov.gr/~sofiakom/OSElementary64-desktop.png"/>
</p>
<p align="justify">
Μέχρι σήμερα έχει δημιουργηθεί η διανομή για την πρωτοβάθμια εκπαίδευση η οποία περιέχει εσωματωμένα λογισμικά ανοιχτού κώδικα για δημοτικά σχολεία. Η διανομή θα εμπλουτιστεί μελλοντικά και με επιπλέον λογισμικά.  
</p>
